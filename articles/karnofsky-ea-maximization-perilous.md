{++{"author":"AI","timestamp":1779998776738}@@---
...
*This piece generally errs on the concise side, gesturing at intuitions rather than trying to nail down my case thoroughly.*
...
- If you're maximizing X, you're asking for trouble by default. You risk breaking/downplaying/shortchanging lots of things that aren't X, which may be important in ways you're not seeing. **Maximizing X conceptually means putting everything else aside for X — a terrible idea unless you're *really sure* you have the right X.** (This idea vaguely echoes some concerns about AI alignment: powerfully maximizing not-exactly-the-right-thing is something of a worst-case event.)
...
- Within this set, some EAs essentially endorse: "The more persons there are in the long-run future, the better it is" while others endorse something close to the opposite: "The more persons there are in the long-run future, the worse it is."
...
Does utilitarianism recommend that we communicate honestly, even when this would make our arguments less persuasive and cause fewer people to take action based on them? Or does utilitarianism recommend that we "say whatever it takes" to get people to donate to the charities we estimate to be best?
...
Even if, say, 80% of utilitarian EAs thought that utilitarianism supported honesty and integrity, while 20% thought it did not, I think the result would be a noticeably and unusually low-integrity community, full of deception and "bad actors" by the standards of its reference class.
...
I'd expect someone who is determined to derive all their actions from utilitarianism to be at high risk of things like being a bad friend (refusing to do inconvenient or difficult things when a friend is in need), being a narrow thinker (not taking an interest in topics that don't have clear relevance to the maximand), and so on. This is because I doubt there is a maximand and calculation method available that reliably replicates all of the many heuristics people use to be "virtuous" on a variety of dimensions.
...
But I doubt you can make a case that's robustly compelling and widely agreed upon, enough to prevent the dynamics I worry about above. Especially if you accept my claim that a significant minority of people behaving badly can be extremely bad.
...
There's a potentially confusing interplay of arguments here. To some degree, I'm calling certain potential dynamics "pitfalls" because I think they would (in fact) be bad for most plausible EA maximands. You might think: "Either these dynamics would be bad for the right maximand, in which case you can't complain that a maximizing mindset is the problem — or they wouldn't be bad for the right maximand, and maybe that means they're just good."

I have a couple of responses to this:

- First, I think the "pitfalls" above are just *broadly bad and should give us pause.* The fact that a low-trust, bitterly divided EA community would probably be less effective is part of why I think it would be a bad thing, but only part of it. I think honesty is good partly because it seems usually instrumentally valuable, but I also think it's just good.
