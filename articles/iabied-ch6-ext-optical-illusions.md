...
**Curvature Blindness Illusion**: This specific illusion was carefully constructed from first principles circa 2017 rather than discovered accidentally, grounded in general curve-blindness phenomena.
...
**Eclipse of Titan (circa 2010)**: Exhausts the viewer's M cones through careful manipulation, allowing less-fatigued L cones to create perception of "brilliant blue" otherwise moderated by simultaneous cone activation.

### Chimerical Colors

Early 2000s cone-activation research produced "impossible" color sensations — "activation-vectors that lie inside the space of neuronally possible activation-vectors, but outside the central 'color spindle.'"
