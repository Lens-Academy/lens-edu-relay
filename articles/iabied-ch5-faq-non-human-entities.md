...
"Blindly race ahead on superintelligence and hope things somehow work out okay" is not the only alternative to "Be a human supremacist who thinks that only humans should exist ++}from {--{"author":"AI","timestamp":1774265981816}@@website--}{++{"author":"AI","timestamp":1774265981816}@@now until the death of the universe." Humanity has the option of deliberately steering toward outcomes where humans (or our descendants) coexist with fantastically beautiful and alien new civilizations.
