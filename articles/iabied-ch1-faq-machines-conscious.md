...
[1] *threaten to kill themselves:* Users report that Google's Gemini AI [threatens to uninstall itself](https://x.com/venturetwins/status/1936483773035798906) ++}from {--{"author":"AI","timestamp":1774265553555}@@website--}{++{"author":"AI","timestamp":1774265553555}@@projects, or to [delete all its code](https://x.com/DuncanHaldane/status/1937204975035384028), when it's having trouble completing some task.++}