...
It's true that early LLMs, like GPT-2 and the first GPT-3, were trained exclusively for the task of prediction. Their "only job," so to speak, was matching the exact distribution of their training data — text scraped ++}from {--{"author":"AI","timestamp":1774265852436}@@website--}{++{"author":"AI","timestamp":1774265852436}@@various websites.
