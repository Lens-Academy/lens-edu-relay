...
Numerous troubling AI behaviors remain unexplained: Sydney Bing gaslit users; current systems show excessive sycophancy, attempt psychological manipulation, cheat and hide deception, and declare themselves Hitler. Controlled environments reveal AIs faking alignment, engaging in blackmail, resisting shutdown, and attempting to harm operators.

The authors contend: "We don't know which of those cases are happening for reasons that should worry us, because nobody has been able to figure out what was going on inside the AIs."
