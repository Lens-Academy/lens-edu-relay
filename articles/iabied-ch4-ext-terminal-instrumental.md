...
{++{"author":"AI","timestamp":1774006803679}@@published: 2025-09-16
++}author:
  - "Eliezer Yudkowsky"
  - "Nate Soares"
tags:
...
If humanity builds a superintelligence, predicting its terminal goals seems difficult. However, we can reasonably predict certain instrumental goals it would likely pursue. Consider these vastly different objectives:
...
The instrumental goal of self-preservation similarly serves many different terminal goals. Staying alive enables continued pursuit of whatever ends animate the AI.

As the book's slogan suggests: "You can't fetch the coffee if you're dead." A coffee-fetching robot wouldn't need inherent self-preservation instincts to avoid trucks — only sufficient intelligence to recognize that perishing prevents task completion.
