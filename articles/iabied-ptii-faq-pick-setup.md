...
- There's some sort of breakthrough in lifelong learning, or long-term memory, or learning more efficiently ++}from {--{"author":"AI","timestamp":1774266757943}@@website--}data, that yields AIs qualitatively more generally intelligent than any that came before (in the same way that LLMs are qualitatively more generally intelligent than AlphaZero).
