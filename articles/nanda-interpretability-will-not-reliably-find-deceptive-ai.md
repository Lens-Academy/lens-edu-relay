...
There’s a common argument made in AI safety discussions: **it is important to work on interpretability research because it is a realistic path to high reliability safeguards on powerful systems** - e.g. as argued in Dario Amodei’s recent “[The Urgency of Interpretability](https://www.darioamodei.com/post/the-urgency-of-interpretability)”.<sup class="footnote-ref"><span><span></span><a href="https://www.alignmentforum.org/posts/PwnadG4BFjaER3MGf/#fn-k5HKy8Qw56e9CboFz-1" id="fnref-k5HKy8Qw56e9CboFz-1" class="">[1]</a></span></sup> Sometimes an even stronger argument is made, that interpretability is the *only* realistic path to highly reliable safeguards - I used to believe both of these arguments myself. **I now disagree with these arguments.**
