---
title: "Interpretability Will Not Reliably Find Deceptive AI — AI Alignment Forum"
...
There’s a common argument made in AI safety discussions: **it is important to work on interpretability research because it is a realistic path to high reliability safeguards on powerful systems** - e.g. as argued in Dario Amodei’s recent “[The Urgency of Interpretability](https://www.darioamodei.com/post/the-urgency-of-interpretability)”.{--{"author":"AI","timestamp":1774022585141}@@<sup class="footnote-ref"><span><span></span><a href="https://www.alignmentforum.org/posts/PwnadG4BFjaER3MGf/#fn-k5HKy8Qw56e9CboFz-1" id="fnref-k5HKy8Qw56e9CboFz-1" class="">[1]</a></span></sup>--}{++{"author":"AI","timestamp":1774022585141}@@[^1]++} Sometimes an even stronger argument is made, that interpretability is the *only* realistic path to highly reliable safeguards - I used to believe both of these arguments myself. **I now disagree with these arguments.**
...
- Reading the chain of thought (with another LLM) and looking for sketchy intent{--{"author":"AI","timestamp":1774022595022}@@<sup class="footnote-ref"><span><span></span><a href="https://www.alignmentforum.org/posts/PwnadG4BFjaER3MGf/#fn-k5HKy8Qw56e9CboFz-5" id="fnref-k5HKy8Qw56e9CboFz-5" class="">[5]</a></span></sup>--}{++{"author":"AI","timestamp":1774022595022}@@[^5]++}
...
{--{"author":"AI","timestamp":1774022635912}@@2.--}{++{"author":"AI","timestamp":1774022635912}@@[^2]:++} More specifically, I basically think the only way we might get high reliability is by using pre-superintelligent systems that are sufficiently aligned/controlled to either do a ton of automated research and find some breakthroughs, or by using them {--{"author":"AI","timestamp":1774022635912}@@a2.  --}{++{"author":"AI","timestamp":1774022635912}@@as a ++}core part of a monitoring or scalable oversight scheme. But the human research trajectory is hard.
{--{"author":"AI","timestamp":1774022696673}@@3.--}{++{"author":"AI","timestamp":1774022696673}@@[^3]:++} Defining “safety” is kinda messy, for the purposes of this post you can interpret it as evaluating ‘is the model thinking misaligned {--{"author":"AI","timestamp":1774022675071}@@thought3.--}{++{"author":"AI","timestamp":1774022675071}@@thoughts',++} or monitoring for ‘is the model currently knowingly taking high-stakes actions against what we want’
{--{"author":"AI","timestamp":1774022782176}@@4.--}{++{"author":"AI","timestamp":1774022782176}@@[^4]:++} I’m not sure what the best precise definition of {--{"author":"AI","timestamp":1774022679550}@@high4.--}{++{"author":"AI","timestamp":1774022679550}@@highly++} reliable is here, maybe 99.9% chance of stopping a catastrophic outcome? It’s not key to my argument.
{--{"author":"AI","timestamp":1774022698546}@@5.--}{++{"author":"AI","timestamp":1774022698546}@@[^5]:++} Obviously, [Chain of Thought can fail to reflect the model’s true reasoning](https://arxiv.org/abs/2503.08679). But I think that for tasks at the limits of its ability it likely needs to use the chain of thought for intermediate steps in the computation, creating an incentive to store key info in there. Of course, there are many ways this can {--{"author":"AI","timestamp":1774022680697}@@fail.to store key info--}{++{"author":"AI","timestamp":1774022680697}@@fail.++} in there. Of course, there are many ways this can fail.