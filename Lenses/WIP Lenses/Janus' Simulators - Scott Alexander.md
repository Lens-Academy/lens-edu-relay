...
#### Chat: Discussion on X-Risk
instructions::
Now that they've finished the article, ask them Ask what they found surprising or new. Check if they can explain `<key concept>` in their own words—it's a key concept.
