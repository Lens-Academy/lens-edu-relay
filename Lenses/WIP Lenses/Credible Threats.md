...
An excerpt from "Credible threats in negotiation", in which the authors discuss threats in the context of game theory as a moving of the negotiation-breakdown-outcome towards something very undesirable so that the other party will do anything to avoid it. Since such negotiation-breakdown-outcomes are most of the time also very undesirable to the person making the threat, it is very important that they are legibly committed to it. It provides the example of Cortès' 
