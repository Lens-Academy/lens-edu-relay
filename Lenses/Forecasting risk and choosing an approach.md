...
There is a broad spectrum of views on how hard the alignment problem is. In Anthropic's "[Core Views on AI Safety](https://www.anthropic.com/news/core-views-on-ai-safety)", the authors discuss three very different possibilities:
...
Among [authors at top machine-learning venues](https://arxiv.org/abs/2401.02843), "[b]etween 38% and 51% of respondents gave at least a 10% chance to advanced AI leading to outcomes as bad as human extinction." Those who are concerned often write failure stories of how AI can lead to catastrophe, like Paul Christiano's "[What failure looks like](https://www.lesswrong.com/posts/HBxe6wdjxK239zajf/what-failure-looks-like)" and the detailed scenario in [AI 2027](https://ai-2027.com/); others are more optimistic and explain why they think "[AI is easy to control](https://optimists.ai/2023/11/28/ai-is-easy-to-control/)".

In this epistemic state of uncertainty, it is useful to do research on the level and nature of AI risks themselves. One approach is [model organisms of misalignment](https://www.lesswrong.com/posts/ChDH335ckdvpxXaXX/model-organisms-of-misalignment-the-case-for-a-new-pillar-of-1) — "in vitro demonstrations of the kinds of failures that might pose existential threats".
...
- **Empirical / iterative.** Some, like Jan Leike, argue for [very empirical iterative approaches](https://aligned.substack.com/p/alignment-optimism), sometimes aiming to use more advanced AI systems to help solve remaining alignment research questions.
...
- **Philosophical.** Yet others take a further step back and argue we need to solve [deep philosophical problems](https://www.lesswrong.com/posts/rASeoR7iZ9Fokzh7L/problems-in-ai-alignment-that-philosophers-could-potentially) on the way to aligned AI.
