...
{++{"author":"AI","timestamp":1772973244026}@@tldr: Language models are often called agents, oracles, or tools — but none of these labels quite fit. This brief introduction proposes a different frame: LLMs as simulators that can take on the properties of any of those things depending on context, while remaining something else underneath.
++}---
