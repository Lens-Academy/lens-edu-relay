...
---
#### Text
content:: {>>{"author":"Ignacio","timestamp":1781461167835}@@General comment: the time estimate (2m) doesn't include the time of watching the video (5m). It would be good if videos or other external materials are included in the time estimate, for those who plan around these.<<}A teacher's job is to **transfer knowledge**.{>>{"author":"Anshuman","timestamp":1782656834219}@@Half cut irrelevant sentence<<}Here{~~{"author":"Elias","timestamp":1782668633280}@@ {--{"author":"Anshuman","timestamp":178266739474~>,~~}Success looks like: at the end of the class, students know what the teacher knew at the start.
