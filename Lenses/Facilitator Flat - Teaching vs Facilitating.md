{++{"author":"AI","timestamp":1781034056254}@@---
...
A facilitator's job is to **help a group think together** about material they've already encountered. The facilitator is *not* the source of the knowledge; success for a facilitator looks like: at the end of the session, participants understand the material better than they could have alone — because the group helped each other interrogate it.
...
Write a paragraph (5-8 sentences) answering, in your own words: **What is the job of a facilitator, and how is it different from a teacher? What's one situation in which I'm likely to drift out of the facilitator role, and what's the trigger?**

You don't have to share this. Writing it is the point — if you can't put the distinction into your own words, you don't yet have it.

#### Chat
instructions::
The trainee has just consumed the Wilder video and the teacher/facilitator comparison.

Learning outcome for this Lens: State the core distinction between teaching and facilitating, identify which mode they default to, and name at least three specific behaviours that change when shifting from one to the other.

Key concepts to surface:
- The distinction is not soft — it changes specific micro-moves
- The pull toward teaching is stronger online than in-person
- Knowing your default mode is the first move; trying to override it without naming it doesn't work
- "Facilitating" is not "teaching with more participation" — it's a different job

Discussion guidance:
- Ask them to state the distinction in their own words. If they say "facilitators are more interactive" or "facilitators ask more questions" — push: *what is the goal* of those questions? Whose understanding are they serving?
