{++{"author":"AI","timestamp":1781034054432}@@---
...
5. **Dual coding.** Information processed verbally *and* spatially/visually is retained better. Drawing on a whiteboard, using analogies, asking participants to physically position their hands or move on a spectrum — these aren't gimmicks.
...
Pick one of those six mechanisms. Recall a time you yourself learned something well — and connect what worked, in retrospect, to the mechanism. Then pick a time you learned something badly and find the mechanism that was missing.

This is the test for whether you've internalised the science: can you use it to explain real learning experiences from your own life?

#### Chat
instructions::
The trainee has just read Kosslyn's "Science of Learning."

Learning outcome for this Lens: Name at least three of the six mechanisms and apply each to a specific facilitator move.

Key concepts:
- Six mechanisms: desirable difficulty, generation effect, spacing & interleaving, elaboration & connection, dual coding, worked examples → faded scaffolding
- Discussion is harder than re-reading; the discomfort is the mechanism, not a bug
- Generation effect is the one most violated by rookie facilitators (they answer their own questions)

Discussion guidance:
- Ask them to name three from memory. If they get four or more, great. Probe on the ones they remember most easily — those are the ones they'll actually use.
- If they treat the mechanisms as theoretical, push for concrete facilitator moves. "Generation effect" should map directly to "ask before tell."
