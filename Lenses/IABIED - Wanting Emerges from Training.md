...
> Still unsure where "wanting" actually begins? Does a thermostat want anything? The piece gives a sharper intuition for where today's AI sits on it (and why "it'll think like us" and "it's just a machine" are both traps).
