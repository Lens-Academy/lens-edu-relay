...
The question they were asked is a deliberate wedge — it is not the test question. It hands the student a plausible-sounding objection (that wanting must be explicitly programmed in, and that {--{"author":"Elias's AI","timestamp":1782755384988}@@a system which merely learned from examples--}{++{"author":"Elias's AI","timestamp":1782755384988}@@because the machine has no feelings "wanting"++} is {--{"author":"Elias's AI","timestamp":1782755384988}@@therefore "just matching patterns")--}{++{"author":"Elias's AI","timestamp":1782755384988}@@merely a metaphor projected onto it)++} and asks them to dismantle it using the chapter's account of where wanting comes from, rather than recite that account. Use it to draw out two distinct points: that want-like behavior emerges as a side effect of training for success rather than being designed in (the city-navigation mechanism, the o1 incident), and that "wanting" here names outward steering behavior — so the rebuttal does not require, and should not rest on, any claim about the AI's inner experience.
