...
2. Then create your [[#Creating a Learning Outcome|Learning Outcomes]] — what students will be able to DO
3. Next, create [[#Creating a Lens|Lenses]] — the articles and discussions that teach each outcome
4. Finally, create [[#Creating a Module|Modules]] — the containers that organize everything
